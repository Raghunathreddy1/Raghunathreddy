...
public class HealthInsurancePolicyController {
	...
	public ResponseEntity<HealthInsurancePolicy> addHealthInsurancePolicy(@Valid @RequestBody HealthInsurancePolicy d) {
	...
	public ResponseEntity<List<HealthInsurancePolicy>> addHealthInsurancePolicys(
			@RequestBody List<HealthInsurancePolicy> ls) {
	...
	public ResponseEntity<HealthInsurancePolicy> updateHealthInsurancePolicy(@RequestBody HealthInsurancePolicy e)
			throws Throwable {
